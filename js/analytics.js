/*
  Sprint 5 - Analítica preparada para Erick Islas Tech
  ----------------------------------------------------
  1) Sustituye GA_MEASUREMENT_ID por tu ID real de Google Analytics 4: G-XXXXXXXXXX
  2) Sustituye CLARITY_PROJECT_ID por tu ID real de Microsoft Clarity si decides usarlo.
  3) Mientras estén vacíos, NO se carga ningún script externo y el sitio sigue funcionando normal.
*/
